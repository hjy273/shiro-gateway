package com.geekerstar.gateway.util.http.common;
...
public class Utils {
    ...
    private static final List<String> INPUTSTREAM_TYPE = Arrays.asList("application/json", "application/xhtml+xml", "application/xml", "text/plain", "text/html", "text/xml");
     ...
     * 判断请求头允许带InputStream
     *
     * @param contentType http请求头
     * @return 返回Boolean
     */
    public static Boolean allowInputStream(String contentType) {
        return INPUTSTREAM_TYPE.contains(contentType.toLowerCase());
    }
